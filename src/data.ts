import { ServiceItem, FeatureItem, PricingPlan, ProjectItem, TestimonialItem, BlogPost } from './types';
...
export const pricingPlans: PricingPlan[] = [
  ...
  },
  {
    id: 'elite',
    name: 'Elite',
    tagline: 'Ideal for individuals who need advanced features and team growth.',
    price: 25,
    period: 'Month',
    highlighted: true,
    features: [
  ...
  },
  {
    id: 'advanced',
    name: 'Advanced',
    tagline: 'Ideal for businesses who need personalized support and enterprise scale.',
    price: 100,
    period: 'Month',
    highlighted: false,
    features: [
...
export const projectItems: ProjectItem[] = [
  ...
  },
  {
    ...
    description: 'Designer crafting innovative brand systems and digital interactions.',
...
export const blogPostsData: BlogPost[] = [
  {
    ...
    content: 'The global digital marketplace is experiencing rapid transformation. Consumers demand seamless multi-channel checkout experiences, instant delivery tracking, and bespoke personalization driven by AI algorithms. Learn how leading brands optimize their funnel.',
    date: 'Sep 18, 2026',
    category: 'E-commerce',
    image: 'https://images.unsplash.com/photo-1556742049-0a67e557224c?q=80&w=800&auto=format&fit=crop',
  },
  {
    id: 'b2',
    title: 'Tech Giants Battle for Dominance in the Digital Adv...',
    excerpt: 'Lorem Ipsum Dolor Sit Amet, Consectetur Adipiscing Elit, Sed Do Eiusmod Tempor Incididun...',
    content: 'Advertising ecosystems continue shifting towards privacy-first attribution and conversational marketing. Discover the latest strategies implemented by market leaders to capture user mindshare without compromising customer trust.',
    date: 'Sep 15, 2026',
    category: 'Technology',
  ...
  },
  {
    ...
    excerpt: 'Lorem Ipsum Dolor Sit Amet, Consectetur Adipiscing Elit, Sed Do Eiusmod Tempor Incididun...',
    content: 'Cross-border digital settlement networks and instant payment gateways are empowering businesses of all sizes to trade frictionlessly across continents. Explore the security protocols and architecture shaping tomorrow.',
    date: 'Sep 12, 2026',
    category: 'Fintech',
