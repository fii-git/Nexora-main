      ...
      <div className="relative z-10 max-w-7xl mx-auto px-5 sm:px-6 lg:px-8 pt-32 sm:pt-36 lg:pt-40 pb-16">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-14 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7">
            ...
            {/* Heading */}
            <h1 className="max-w-[760px] text-[48px] sm:text-[62px] lg:text-[72px] xl:text-[78px] font-black leading-[0.98] tracking-[-0.045em] text-[#101014]">
              Digital Product
              <br />

              <span className="bg-gradient-to-r from-[#168DFF] via-[#4265FF] to-[#B02CFF] bg-clip-text text-transparent">
                Agency
              </span>{" "}
              Marketing
            </h1>
            ...
            {/* Description */}
            <p className="mt-7 max-w-[680px] text-base sm:text-lg leading-8 text-slate-500">
              NEXORA is a digital agency focused on creating modern
              websites, digital products, and experiences that help
            ...
            <div className="flex flex-wrap items-center gap-5 mt-9">
              ...
              <button
                ...
                className="group inline-flex items-center gap-4 px-7 py-4 rounded-full bg-gradient-to-r from-[#168DFF] via-[#4168FF] to-[#A52BFF] text-white font-bold text-sm sm:text-base shadow-lg shadow-blue-200 hover:shadow-xl hover:shadow-purple-200 hover:-translate-y-0.5 transition-all duration-300 cursor-pointer"
              >
              ...
              >
                <span className="w-12 h-12 rounded-full flex items-center justify-center bg-gradient-to-br from-[#168DFF] to-[#653BFF] text-white shadow-md shadow-blue-200 group-hover:scale-105 transition-transform">
          ...
          <div className="lg:col-span-5 relative min-h-[560px] sm:min-h-[620px]">
            ...
            {/* Big circular gradient background */}
            <div className="absolute top-8 right-[-30px] w-[430px] h-[430px] sm:w-[500px] sm:h-[500px] rounded-full bg-gradient-to-br from-blue-100 via-indigo-100 to-purple-100 opacity-80" />
            ...
            <div className="absolute right-0 top-0 w-[58%] h-[470px] sm:h-[530px] rounded-[28px] overflow-hidden border-[6px] border-white shadow-2xl z-30">
              ...
              {/* Instagram badge */}
              <div className="absolute -top-5 right-4 w-12 h-12 rounded-full bg-gradient-to-br from-pink-500 via-red-500 to-orange-400 flex items-center justify-center shadow-lg">
              ...
              <div className="absolute top-7 left-5 right-5">
                <div className="bg-white/95 backdrop-blur-sm rounded-[22px] px-5 py-4 shadow-xl">
                  <p className="text-xs sm:text-sm font-bold leading-5 text-slate-800">
                    ...
                    that make people lives simpler."
                  </p>
                </div>
              </div>
            ...
            <div className="absolute left-[-10px] bottom-24 sm:bottom-16 z-40 bg-white rounded-[22px] px-4 py-4 shadow-xl border border-slate-100">
            ...
            <div
              className="absolute right-[-20px] bottom-16 w-32 h-32 opacity-40"
              style={{
                backgroundImage:
                  "radial-gradient(#2587FF 1.5px, transparent 1.5px)",
            ...
            <div className="absolute bottom-0 right-4 hidden sm:block text-[#2587FF] rotate-[-5deg]">
              ...
              <p className="text-lg font-semibold italic ml-8">
                Real Results
              </p>
            </div>
