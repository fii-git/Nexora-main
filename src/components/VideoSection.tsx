    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-end mb-12 sm:mb-14">
          ...
          <div className="lg:col-span-5">
            ...
            <p className="text-slate-500 text-sm sm:text-base leading-7">
              NEXORA is a digital agency focused on creating meaningful
              digital experiences through strategy, design, and technology.
              We help businesses turn ideas into digital products that are
              useful, memorable, and built for what's next.
            </p>
            ...
            <button
              ...
              type="button"
              onClick={onOurStory}
              className="group mt-6 inline-flex items-center gap-3 px-6 py-3 rounded-full bg-[#111114] hover:bg-[#2587FF] text-white text-sm font-bold transition-all duration-300 shadow-lg hover:shadow-blue-200 cursor-pointer"
            >
              <span>Our Story</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 mt-10 sm:mt-12">
          ...
          <div>
            <p className="text-2xl font-black text-[#111114]">
              Strategy
            </p>
          ...
          <div>
            ...
            <p className="mt-2 text-sm leading-6 text-slate-500">
              We create intuitive and memorable experiences around
              your brand.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="mt-2 text-sm leading-6 text-slate-500">
              We turn ideas into fast, responsive, and scalable
              digital products.
            </p>
          </div>
